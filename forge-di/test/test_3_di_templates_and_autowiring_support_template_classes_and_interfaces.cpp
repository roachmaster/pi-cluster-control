...
#ifdef HAS_IMPL_scn_3_di_templates_and_autowiring_support_template_classes_and_interfaces
static std::unique_ptr<scn_3_di_templates_and_autowiring_support_template_classes_and_interfaces> forge_bdd_steps() {
    return std::make_unique<impl_scn_3_di_templates_and_autowiring_support_template_classes_and_interfaces>();
}
#else
static std::unique_ptr<scn_3_di_templates_and_autowiring_support_template_classes_and_interfaces> forge_bdd_steps() {
    return std::make_unique<stub_scn_3_di_templates_and_autowiring_support_template_classes_and_interfaces>();
}
#endif
