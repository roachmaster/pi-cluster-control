...
#ifdef HAS_IMPL_scn_5_di_testing_and_debugging_enable_debug_output_for_di_resolution
static std::unique_ptr<scn_5_di_testing_and_debugging_enable_debug_output_for_di_resolution> forge_bdd_steps() {
    return std::make_unique<impl_scn_5_di_testing_and_debugging_enable_debug_output_for_di_resolution>();
}
#else
static std::unique_ptr<scn_5_di_testing_and_debugging_enable_debug_output_for_di_resolution> forge_bdd_steps() {
    return std::make_unique<stub_scn_5_di_testing_and_debugging_enable_debug_output_for_di_resolution>();
}
#endif
