...
#ifdef HAS_IMPL_scn_1_di_metadata_and_constructors_resolve_constructor_dependencies
static std::unique_ptr<scn_1_di_metadata_and_constructors_resolve_constructor_dependencies> forge_bdd_steps() {
    return std::make_unique<impl_scn_1_di_metadata_and_constructors_resolve_constructor_dependencies>();
}
#else
static std::unique_ptr<scn_1_di_metadata_and_constructors_resolve_constructor_dependencies> forge_bdd_steps() {
    return std::make_unique<stub_scn_1_di_metadata_and_constructors_resolve_constructor_dependencies>();
}
#endif
