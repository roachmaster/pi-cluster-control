...
#ifdef HAS_IMPL_scn_3_agent_package_reporting_agent_lists_simplified_packages
static std::unique_ptr<scn_3_agent_package_reporting_agent_lists_simplified_packages> forge_bdd_steps() {
    return std::make_unique<impl_scn_3_agent_package_reporting_agent_lists_simplified_packages>();
}
#else
static std::unique_ptr<scn_3_agent_package_reporting_agent_lists_simplified_packages> forge_bdd_steps() {
    return std::make_unique<stub_scn_3_agent_package_reporting_agent_lists_simplified_packages>();
}
#endif
