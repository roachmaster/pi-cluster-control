...
// Step Interface
class cppforge_run_regression_checks_on_upstream_modules_steps {
public:
    ...
    virtual ~cppforge_run_regression_checks_on_upstream_modules_steps() = default;
};

// Stub Implementation (throws failures)
class stub_run_regression_checks_on_upstream_modules_steps : public cppforge_run_regression_checks_on_upstream_modules_steps {
