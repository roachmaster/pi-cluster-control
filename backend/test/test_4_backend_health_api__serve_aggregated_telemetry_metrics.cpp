...
// Step Interface
class cppforge_serve_aggregated_telemetry_metrics_steps {
public:
    ...
    virtual ~cppforge_serve_aggregated_telemetry_metrics_steps() = default;
};

// Stub Implementation (throws failures)
class stub_serve_aggregated_telemetry_metrics_steps : public cppforge_serve_aggregated_telemetry_metrics_steps {
