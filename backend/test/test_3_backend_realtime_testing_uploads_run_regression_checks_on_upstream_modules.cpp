...
#ifdef HAS_IMPL_scn_3_backend_realtime_testing_uploads_run_regression_checks_on_upstream_modules
static std::unique_ptr<scn_3_backend_realtime_testing_uploads_run_regression_checks_on_upstream_modules> forge_bdd_steps() {
    return std::make_unique<impl_scn_3_backend_realtime_testing_uploads_run_regression_checks_on_upstream_modules>();
}
#else
static std::unique_ptr<scn_3_backend_realtime_testing_uploads_run_regression_checks_on_upstream_modules> forge_bdd_steps() {
    return std::make_unique<stub_scn_3_backend_realtime_testing_uploads_run_regression_checks_on_upstream_modules>();
}
#endif
