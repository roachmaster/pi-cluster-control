...
#ifdef HAS_IMPL_scn_4_backend_health_api_serve_aggregated_telemetry_metrics
static std::unique_ptr<scn_4_backend_health_api_serve_aggregated_telemetry_metrics> forge_bdd_steps() {
    return std::make_unique<impl_scn_4_backend_health_api_serve_aggregated_telemetry_metrics>();
}
#else
static std::unique_ptr<scn_4_backend_health_api_serve_aggregated_telemetry_metrics> forge_bdd_steps() {
    return std::make_unique<stub_scn_4_backend_health_api_serve_aggregated_telemetry_metrics>();
}
#endif
