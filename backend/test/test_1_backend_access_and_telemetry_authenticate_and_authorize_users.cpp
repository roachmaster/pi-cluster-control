...
#ifdef HAS_IMPL_scn_1_backend_access_and_telemetry_authenticate_and_authorize_users
static std::unique_ptr<scn_1_backend_access_and_telemetry_authenticate_and_authorize_users> forge_bdd_steps() {
    return std::make_unique<impl_scn_1_backend_access_and_telemetry_authenticate_and_authorize_users>();
}
#else
static std::unique_ptr<scn_1_backend_access_and_telemetry_authenticate_and_authorize_users> forge_bdd_steps() {
    return std::make_unique<stub_scn_1_backend_access_and_telemetry_authenticate_and_authorize_users>();
}
#endif
