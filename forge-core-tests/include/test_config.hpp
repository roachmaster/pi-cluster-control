 ...
 */
    ...
    public:
         ...
         */
        TestConfig(std::string projName, std::string featuresDir, int expectedCount, bool verbose)
                : projectName(std::move(projName)), featuresDirectory(std::move(featuresDir)), expectedScenarioCount(expectedCount),
