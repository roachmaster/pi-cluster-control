...
#ifdef HAS_IMPL_scn_1_monitor_and_register_agents_agent_initiates_registration
static std::unique_ptr<scn_1_monitor_and_register_agents_agent_initiates_registration> forge_bdd_steps() {
    return std::make_unique<impl_scn_1_monitor_and_register_agents_agent_initiates_registration>();
}
#else
static std::unique_ptr<scn_1_monitor_and_register_agents_agent_initiates_registration> forge_bdd_steps() {
    return std::make_unique<stub_scn_1_monitor_and_register_agents_agent_initiates_registration>();
}
#endif
