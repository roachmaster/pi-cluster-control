...
// Step Interface
class cppforge_agent_initiates_registration_steps {
public:
    ...
    virtual ~cppforge_agent_initiates_registration_steps() = default;
};

// Stub Implementation (throws failures)
class stub_agent_initiates_registration_steps : public cppforge_agent_initiates_registration_steps {
