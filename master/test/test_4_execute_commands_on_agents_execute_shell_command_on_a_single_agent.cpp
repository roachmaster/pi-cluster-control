...
#ifdef HAS_IMPL_scn_4_execute_commands_on_agents_execute_shell_command_on_a_single_agent
static std::unique_ptr<scn_4_execute_commands_on_agents_execute_shell_command_on_a_single_agent> forge_bdd_steps() {
    return std::make_unique<impl_scn_4_execute_commands_on_agents_execute_shell_command_on_a_single_agent>();
}
#else
static std::unique_ptr<scn_4_execute_commands_on_agents_execute_shell_command_on_a_single_agent> forge_bdd_steps() {
    return std::make_unique<stub_scn_4_execute_commands_on_agents_execute_shell_command_on_a_single_agent>();
}
#endif
