...
// Step Interface
class scn_5_plugin_architecture_register_and_execute_a_cppforge_plugin {
public:
    ...
    virtual ~scn_5_plugin_architecture_register_and_execute_a_cppforge_plugin() = default;
};

// Stub Implementation (throws failures)
class stub_scn_5_plugin_architecture_register_and_execute_a_cppforge_plugin : public scn_5_plugin_architecture_register_and_execute_a_cppforge_plugin {
    // No overrides – just uses FAIL() behavior from base class
};

// Test Case
TEST(scn_5_plugin_architecture_register_and_execute_a_cppforge_plugin_test, executes_scenario) {
    stub_scn_5_plugin_architecture_register_and_execute_a_cppforge_plugin steps;
