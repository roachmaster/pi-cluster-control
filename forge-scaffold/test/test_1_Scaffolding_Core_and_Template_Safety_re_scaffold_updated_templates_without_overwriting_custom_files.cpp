...
#ifdef HAS_IMPL_scn_1_scaffolding_core_and_template_safety_re_scaffold_updated_templates_without_overwriting_custom_files
static std::unique_ptr<scn_1_scaffolding_core_and_template_safety_re_scaffold_updated_templates_without_overwriting_custom_files> forge_bdd_steps() {
    return std::make_unique<impl_scn_1_scaffolding_core_and_template_safety_re_scaffold_updated_templates_without_overwriting_custom_files>();
}
#else
static std::unique_ptr<scn_1_scaffolding_core_and_template_safety_re_scaffold_updated_templates_without_overwriting_custom_files> forge_bdd_steps() {
    return std::make_unique<stub_scn_1_scaffolding_core_and_template_safety_re_scaffold_updated_templates_without_overwriting_custom_files>();
}
#endif
